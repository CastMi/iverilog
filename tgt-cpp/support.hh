...
#ifndef INC_CPPSUPPORT_HH
#define INC_CPPSUPPORT_HH
...
class support_function : public cpp_function {
public:
   support_function(support_function_t type)
      : cpp_function(function_name(type), function_type(type)),
        type_(type) {}
   void emit(std::ostream &of, int level) const;
   static const char *function_name(support_function_t type);
   static cpp_type *function_type(support_function_t type);
